function analysis(
    ...
    for yr in yrbeg : yrend
        ...
        @info "$(modulelog()) - Calculating monthly climatology and diurnal statistics for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr ..."
        for mo in 1 : 12

            if verbose
                @info "$(modulelog()) - Loading $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr $(monthname(mo)) ..."
            end
            ...
            if verbose
                @info "$(modulelog()) - Calculating daily means for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr $(monthname(mo)) ..."
            end
            ...
            if verbose
                @info "$(modulelog()) - Calculating diurnal statistics for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr $(monthname(mo)) ..."
            end
            ...
            if verbose
                @info "$(modulelog()) - Calculating monthly climatology for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr $(monthname(mo)) ..."
            end
        ...
        @info "$(modulelog()) - Calculating yearly climatology for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr ..."
        ...
        @info "$(modulelog()) - Calculating zonal-averaged climatology for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr ..."
        ...
        @info "$(modulelog()) - Calculating meridional-averaged climatology for $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) during $yr ..."
...
function save(
    ...
    @info "$(modulelog()) - Saving analyzed $(e5ds.lname) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) for $(year(date)) ..."
    ...
    @info "$(modulelog()) - Analyzed $(uppercase(e5ds.lname)) $(evar.vname) data in $(ereg.geo.name) (Horizontal Resolution: $(ereg.resolution)) for $(year(date)) has been saved into $(fnc)."
